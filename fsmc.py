...
class fsmc_sram_buffer(object):
    ...
    def memory_init(self):
        ...
        stm.mem32[stm.GPIOG + 0x00] |= 0x00200AAA
        ...
        stm.mem32[stm.GPIOG + 0x08] |= 0x00300FFF
        #### FMC INIT ###########################
        stm.mem32[0xA0000000 + 0x00000010] |= 0x00001011      ## write on FSMC_BCR2
        stm.mem32[0xA0000004 + 0x00000010] |= 0x00000b00      ## write on FSMC_BTR2
        stm.mem32[0xA0000104 + 0x00000010] |= 0x00000b00      ## write on FSMC_BWTR2
    ...
    def fsmc_register_dump(self):
        ...
        FSMC_BCR2 = stm.mem32[0xA0000000 + 0x00000010]
        FSMC_BTR2 = stm.mem32[0xA0000004 + 0x00000010] 
        FSMC_BWTR2 = stm.mem32[0xA0000104 + 0x00000010]
        print("-- REGISTER DUMP --")
